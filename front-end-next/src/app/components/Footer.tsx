        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                <nav className="-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6" aria-label="Footer">
                    ...
                    <Link href="#" className="text-gray-600 hover:text-gray-900">Press</Link>
                    <Link href="#" className="text-gray-600 hover:text-gray-900">Accessibility</Link>
                    <Link href="#" className="text-gray-600 hover:text-gray-900">Partners</Link>
                </nav>
